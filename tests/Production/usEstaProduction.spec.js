...
test('US ESTA', async ({ page, context }) => {
  ...
  await page.waitForURL("**/usa/apply-now/passport-details/0", {waitUntil: 'domcontentloaded'})
  await appFunctions.step_2(page, continue_sidebar)
  await page.waitForURL("**/usa/apply-now/address-details/0", {waitUntil: 'domcontentloaded'})
  await appFunctions.step_3c(page, continue_sidebar)
  await page.waitForURL("**/usa/apply-now/additional-info/0", {waitUntil: 'domcontentloaded'})
  ...
  await continue_sidebar.click()
  await page.waitForURL("**/usa/apply-now/checkout", {waitUntil: 'domcontentloaded'})
