...
test('Dominican Republic', async ({ page }) => {
  ...
  await page.waitForURL("**/dominican-republic/apply-now/passport-details/0", {waitUntil: 'domcontentloaded'})
  await appFunctions.step_2(page, continue_sidebar)
  await page.waitForURL("**/dominican-republic/apply-now/address-details/0", {waitUntil: 'domcontentloaded'})
  await appFunctions.step_3c(page, continue_sidebar)
  await page.waitForURL("**/dominican-republic/apply-now/additional-info/0", {waitUntil: 'domcontentloaded'})
  ...
  await continue_sidebar.click()
  await page.waitForURL("**/dominican-republic/apply-now/checkout", {waitUntil: 'domcontentloaded'})
