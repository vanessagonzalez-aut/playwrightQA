...
test('Jamaica', async ({ page }) => {
  ...
  await page.waitForURL("**/jamaica/apply-now/passport-details/0", {waitUntil: 'domcontentloaded'})
  await appFunctions.step_2(page, continue_sidebar)
  await page.waitForURL("**/jamaica/apply-now/address-details/0", {waitUntil: 'domcontentloaded'})
  await appFunctions.step_3c(page, continue_sidebar)
  await page.waitForURL("**/jamaica/apply-now/additional-info/0", {waitUntil: 'domcontentloaded'})
  ...
  await continue_sidebar.click()
  await page.waitForURL("**/jamaica/apply-now/checkout", {waitUntil: 'domcontentloaded'})
