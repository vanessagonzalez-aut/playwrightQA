...
test('FastPassport - Online Passport and MIN status', async({page, context}) =>{
  ...
  await next_btn.click()
  await page.waitForURL(general_url + "fastpassport.visachinaonline.com/order/" + Order_num + "/continue#step=contact_and_updates")
  ...
  await page.getByTestId("Order where two applicant's have the same name").click()
  await page.waitForTimeout(2000)
  await expect(page.getByTestId("Order where two applicant's have the same name")).toBeVisible()
